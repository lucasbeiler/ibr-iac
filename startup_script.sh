...
# Ensure proper UTC time synchronization.
setup-timezone -z UTC
sed -i 's/pool.ntp.org/169.254.169.123/' /etc/conf.d/ntpd # Set NTP server from internal VPC in case we use busybox ntpd in the future.
